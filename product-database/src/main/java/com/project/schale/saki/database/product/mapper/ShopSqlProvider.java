...
import com.project.schale.saki.database.product.model.ShopExample.Criteria;
import com.project.schale.saki.database.product.model.ShopExample.Criterion;
...
public class ShopSqlProvider {
     ...
     * @mbg.generated Mon Oct 21 22:15:08 JST 2024
     */
    public String insertSelective(Shop row) {
        SQL sql = new SQL();
        sql.INSERT_INTO("shops");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Shop row = (Shop) parameter.get("row");
     ...
     * @mbg.generated Mon Oct 21 22:15:08 JST 2024
     */
    public String updateByPrimaryKeySelective(Shop row) {
        SQL sql = new SQL();
        sql.UPDATE("shops");
